...
export const Hero = () => {
  ...
  return (
    ...
    >
      ...
      className="absolute h-[344px] w-[344px] md:h-[580px] md:w-[580px] border border-white opacity-30 rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
        <div className="absolute h-2 w-2 left-0 bg-white rounded-full top-1/2 -translate-x-1/2 -translate-y-1/2"></div>
        <div className="absolute h-2 w-2 left-1/2 bg-white rounded-full top-0 -translate-x-1/2 -translate-y-1/2"></div>
        <div className="absolute h-5 w-5 left-full border border-white rounded-full top-1/2 -translate-x-1/2 -translate-y-1/2 inline-flex items-center justify-center">
          <div className="h-2 w-2 left-full bg-white rounded-full"></div>
        </div>
      </motion.div>
      {/* End Ring 1 */}
      {/* Start Ring 2 */}
      ...
      <div className="container relative mt-16">
        ...
        <p className="text-lg md:text-xl text-white/70 mt-5 text-center max-w-xl mx-auto">
          ...
          technology meets user-friendly SEO tool.
        </p>
