        ...
        <div className="flex justify-between items-center md:border border-white/15 md:p-2.5 rounded-xl max-w-2xl mx-auto relative">
          ...
          <div className="hidden md:block">
            <nav className="flex gap-8 text-sm">
              ...
              <a href="#" className=" text-white/70 hover:text-white font-medium transition">Developers</a>
              <a href="#" className=" text-white/70 hover:text-white font-medium transition">Pricing</a>
              <a href="#" className=" text-white/70 hover:text-white font-medium transition">Changelog</a>
            </nav>
          </div>
